...
6. Система перенправляє користувача на форму входу в акаунт.
...
***ВИКЛЮЧНІ СИТУАЦІЇ:*** Клієнт ввід дані неправильно.
...
***ОСНОВНИЙ СЦЕНАРІЙ:***
1. Експерт переходить авторизований та переходить на сторінку з опитуваннями.
...
***ВИКЛЮЧНІ СИТУАЦІЇ:*** Опитування з таким id не знайдено
