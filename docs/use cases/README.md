...
3. Клієнт обирає категорії експертів, які його цікавлять за спеціальністю та надсилає форму.
...
@startuml
  ...
  |Система|
  : Отримує запит;
  : Надає пусте опитування;

  |Клієнт|
  : Уводить питання;
  : Обирає категорії експертів за спеціальністю;
